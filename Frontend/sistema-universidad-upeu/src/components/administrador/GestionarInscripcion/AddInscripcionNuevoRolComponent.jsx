...
function AddInscripcionNuevoRolComponent() {
    ...
    async function saveOrUpdateInscripcion(e) {
        ...
        if (id) {
            try {
                ...
                navigate("/list-inscripcion-nuevo-rol");
            } catch (error) {
                console.error(error);
            }
        } else {
        ...
        <div className="container">
            ...
            <form>
                ...
                <div>
                    ...
                    &nbsp;
                    &nbsp;
                    <Link to="/list-inscripcion-nuevo-rol">Cancelar</Link>
                </div>
            </form>
        </div>
    )
...
export default AddInscripcionNuevoRolComponent;